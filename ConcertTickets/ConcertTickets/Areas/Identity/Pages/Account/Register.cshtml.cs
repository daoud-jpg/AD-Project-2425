...
namespace ConcertTickets.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "De {0} moet ten minste {2} en maximaal {1} tekens lang zijn.", MinimumLength = 6)]
            ...
            [Compare("Password", ErrorMessage = "Het paswoord en het bevestigde paswoord komen niet overeen.")]
